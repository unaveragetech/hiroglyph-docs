...
1. **Cryptographic layer** — AES-based encryption, PBKDF2 key derivation, SHA3-512 integrity hashing.
...
```
┌──────────────┐     ┌──────────────┐     ┌──────────────┐     ┌──────────────┐
│  Source File │────▶│  Encoder     │────▶│  .glyph File │────▶│   Runner     │
│  (.py / .js  │     │              │     │              │     │              │
│  .html / .ts │     │ 1. Hash      │     │ Hieroglyphic │     │ 1. Decode    │
│  .java / .bat│     │ 2. Encrypt   │     │ symbols only │     │ 2. Decrypt   │
│  etc.)       │     │ 3. Encode    │     │ No filenames │     │ 3. Verify    │
└──────────────┘     └──────────────┘     │ No headers   │     │ 4. Execute   │
                                           └──────────────┘     └──────────────┘
```
...
| `aes`      | Raw AES key string                                  | Maximum control / scripting      |
